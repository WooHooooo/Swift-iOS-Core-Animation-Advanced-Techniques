...
let rowTitles = [
    ...
    ["6.1.CAShapeLayer","6.2.CATextLayer","6.2.CATextLayer-富文本","6.2.LayerLabel","6.3.CATransformLayer","6.4.CAGradientLayer","6.5.CAReplicatorLayer","6.8.CAEmitterLayeer","6.9.CAEAGLLayer","6.10.AVPlayerLayer","6.10.AVPlayerLayer_MIX"],
    ["7.1.事务","7.2.完成块","7.3.图层行为","7.3.涂层行为-推进过渡","7.4.呈现与模型"],
    ["8.1.属性动画","8.1.属性动画-KVC","8.1.属性动画-关键帧","8.1.属性动画-CGPath","8.2.动画组","8.3.过渡","8.3.自定义动画","8.4. 在动画过程中取消动画"],
    ["9.1.CAMediaTiming协议-duration和repeatCount","9.1.CAMediaTiming协议-RepeatDuration","9.1.CAMediaTiming协议-相对时间","9.3.手动动画"],
    ["10.1.动画速度-UIView","10.2.三次贝塞尔缓冲函数","10.2.反弹球-基于关键帧","10.2.反弹球-流程自动化"],
    ["11.1.定时帧-NSTimer反弹球","11.1.定时帧-CADisplayLink反弹球"],
    [],
    [],
    [],
    []
...
let detailView:[[UIViewController]] = [
    ...
    [
        Special_CAShapeLayer(),Special_CATextLayer(),Special_CATextLayer_RichText(),LayerLabel_test(),Special_CATransformLayer(),Special_CAGradientLayer(),Special_CAReplicatorLayer(),Special_CAEmitterLayeer(),Special_CAEAGLLayer_OC(),Special_AVPlayerLayer(),Special_AVPlayerLayer_MIX()
    ],
    [
        Transactions(),Completion_Blocks(),LayerActions(),AdvancingTransition(),PresentationLayer()
    ],
    [
        PropertyAnimations(),PropertyAnimations_KVC(),PropertyAnimations_KeyFrames(),PropertyAnimations_CGPath(),AnimationGroup(),Transition(),CustomAnimation(),CancelAnimation()
    ],
    [
        Duration_RepeatCount(),RepeatDuration(),RelativelyTime(),ManuallyAnimation()
    ],
    [
        UIViewCAMediaTimingFunction(),TriBezier(),ReboundBall_KeyTimes(),ReboundBall_Auto()
    ],
    [
        ReboundBall_NSTimer(),ReboundBall_CADisplayLink()
    ]
]
